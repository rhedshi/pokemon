...
_REQUESTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_PERFORMANCE_METRICS', index=67, number=407,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHECK_CHALLENGE', index=68, number=600,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VERIFY_CHALLENGE', index=69, number=601,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ECHO', index=70, number=666,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_REGISTRATION', index=71, number=800,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_ACTION_LOG', index=72, number=801,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_CERTIFICATION', index=73, number=802,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_UPDATE', index=74, number=803,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_ACTION', index=75, number=804,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_DOWSER', index=76, number=805,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SFIDA_CAPTURE', index=77, number=806,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LIST_AVATAR_CUSTOMIZATIONS', index=78, number=807,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SET_AVATAR_ITEM_AS_VIEWED', index=79, number=808,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_INBOX', index=80, number=809,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LIST_GYM_BADGES', index=81, number=811,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_GYM_BADGE_DETAILS', index=82, number=812,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USE_ITEM_MOVE_REROLL', index=83, number=813,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='USE_ITEM_RARE_CANDY', index=84, number=814,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AWARD_FREE_RAID_TICKET', index=85, number=815,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH_ALL_NEWS', index=86, number=816,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MARK_READ_NEWS_ARTICLE', index=87, number=817,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_PLAYER_DISPLAY_INFO', index=88, number=818,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_NEW_QUESTS', index=89, number=900,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_QUEST_DETAILS', index=90, number=901,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLETE_QUEST', index=91, number=902,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REMOVE_QUEST', index=92, number=903,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUEST_ENCOUNTER', index=93, number=904,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPLETE_QUEST_STAMP_CARD', index=94, number=905,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REGISTER_PUSH_NOTIFICATION', index=95, number=5000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNREGISTER_PUSH_NOTIFICATION', index=96, number=5001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_NOTIFICATION_STATUS', index=97, number=5002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OPT_OUT_PUSH_NOTIFICATION_CATEGORY', index=98, number=5003,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DOWNLOAD_GAME_MASTER_TEMPLATES', index=99, number=5004,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_INVENTORY', index=100, number=5005,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REDEEM_PASSCODE', index=101, number=5006,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PING', index=102, number=5007,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ADD_LOGIN_ACTION', index=103, number=5008,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REMOVE_LOGIN_ACTION', index=104, number=5009,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LIST_LOGIN_ACTION', index=105, number=5010,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ADD_NEW_POI', index=106, number=5011,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROXY_SOCIAL_ACTION', index=107, number=5012,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_TELEMETRY', index=108, number=5013,
      options=None,
      type=None),
  ],
