...
_QUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quest_id', full_name='pogoprotos.data.quests.Quest.quest_id', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quest_seed', full_name='pogoprotos.data.quests.Quest.quest_seed', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quest_context', full_name='pogoprotos.data.quests.Quest.quest_context', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='template_id', full_name='pogoprotos.data.quests.Quest.template_id', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='progress', full_name='pogoprotos.data.quests.Quest.progress', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='goal', full_name='pogoprotos.data.quests.Quest.goal', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='pogoprotos.data.quests.Quest.status', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quest_rewards', full_name='pogoprotos.data.quests.Quest.quest_rewards', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='creation_timestamp_ms', full_name='pogoprotos.data.quests.Quest.creation_timestamp_ms', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='last_update_timestamp_ms', full_name='pogoprotos.data.quests.Quest.last_update_timestamp_ms', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='compeletion_timestamp_ms', full_name='pogoprotos.data.quests.Quest.compeletion_timestamp_ms', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fort_id', full_name='pogoprotos.data.quests.Quest.fort_id', index=15,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='admin_generated', full_name='pogoprotos.data.quests.Quest.admin_generated', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stamp_count_override_enabled', full_name='pogoprotos.data.quests.Quest.stamp_count_override_enabled', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stamp_count_override', full_name='pogoprotos.data.quests.Quest.stamp_count_override', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='s2_cell_id', full_name='pogoprotos.data.quests.Quest.s2_cell_id', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='story_quest_template_version', full_name='pogoprotos.data.quests.Quest.story_quest_template_version', index=20,
