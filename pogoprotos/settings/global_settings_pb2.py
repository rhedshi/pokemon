...
_GLOBALSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='telemetry_global_settings', full_name='pogoprotos.settings.GlobalSettings.telemetry_global_settings', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='login_settings', full_name='pogoprotos.settings.GlobalSettings.login_settings', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='quest_global_settings', full_name='pogoprotos.settings.GlobalSettings.quest_global_settings', index=19,
